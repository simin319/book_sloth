			...
			<div id="wrapper">
						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="index.php" class="logo">
									<span class="fa fa-book"></span> <span class="title">Book Sloth</span>
								</a>
				...
				<!-- Menu -->
					<nav id="menu">
						<h2>Menu</h2>
						<ul>
							<li><a href="http://localhost/LMS/user/userlogin.php" class="active">Login</a></li>

							<li><a href="http://localhost/LMS/user/userreg.php" class="active">Registration</a></li>	
						</ul>
					</nav>
